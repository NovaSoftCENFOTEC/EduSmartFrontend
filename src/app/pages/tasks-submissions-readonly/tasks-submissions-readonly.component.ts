...
import { TaskSubmissionListComponent } from '../../components/task-submission/task-submission-list/task-submission-list.component';
import { TaskSubmissionFormComponent } from '../../components/task-submission/task-submission-form/task-submission-form.component';
'../../components/task-submission/task-submission-list/task-submission-list.component';

@Component({
  selector: 'app-task-submissions-readonly',
  standalone: true,
  imports: [
    CommonModule,
    PaginationComponent,
  ...
  templateUrl: './tasks-submissions-readonly.component.html',
  styleUrls: ['./tasks-submissions-readonly.component.scss']
})
export class TasksSubmissionsReadOnlyComponent implements OnInit {
  ...
  if (!this.originalSubmission) {
    console.warn('No hay originalSubmission para actualizar');
    return;
  }
  ...
  console.log('Actualizando entrega con:', payloadToSend);
  ...
  console.log('Evento recibido en TaskSubmissionsComponent:', item);
